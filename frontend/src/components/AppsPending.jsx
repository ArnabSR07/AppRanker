    ...
    <div>
        ...
        <div className='bg-cyan-800 pb-5 rounded-xl'>
            ...
            <div className='bg-cyan-950 flex justify-center items-center gap-1 md:gap-8 py-2 px-1 md:px-5'>
                ...
                <input type="text" className='w-22 md:w-40 bg-cyan-800 rounded-md px-2 py-2 text-gray-400' placeholder='Filter by name...' />
                <input type="text" className='w-22 md:w-40 bg-cyan-800 rounded-md px-2 py-2 text-gray-400' placeholder='Filter by vendor...' />
                <input type="text" className='w-22 md:w-40 bg-cyan-800 rounded-md px-2 py-2 text-gray-400' placeholder='Filter by name...' />
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='flex items-center justify-start  gap-4 px-2 md:px-8'>
                    ...
                    <div className='flex flex-col xl:flex-row items-center justify-center gap-2 lg:gap-5 ps-3 py-2'>
                        <div className='bg-blue-800 text-blue-300 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-xs lg:text-sm'><FaRegEye className='h-3 w-3 sm:h-4 sm:w-5'/>View</div>
                        <div className='bg-green-800 text-green-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-xs  lg:text-sm'><TiTickOutline className='h-3 w-3 sm:h-4 sm:w-5'/>Approve</div>
                        <div className='bg-yellow-800 text-yellow-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-xs  lg:text-sm'><IoAlertCircleOutline className='h-3 w-3 sm:h-4 sm:w-5'/>Request Changes</div>
                        <div className='bg-red-800 text-red-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-xs lg:text-sm'><GiCancel className='h-3 w-3 sm:h-4 sm:w-5'/>Reject</div>
                    </div>
                ...
                <div className='flex items-center justify-start  gap-4 px-2 md:px-8'>
                    ...
                    <p className='text-gray-300 w-44 text-center'>22 Oct, 2025</p>
                    <div className='flex flex-col xl:flex-row items-center justify-center gap-2 lg:gap-5 ps-3 py-2'>
                        <div className='bg-blue-800 text-blue-300 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-sm'><FaRegEye className='h-3 w-3 sm:h-4 sm:w-5'/>View</div>
                        <div className='bg-green-800 text-green-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-sm'><TiTickOutline className='h-3 w-3 sm:h-4 sm:w-5'/>Approve</div>
                        <div className='bg-yellow-800 text-yellow-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-sm'><IoAlertCircleOutline className='h-3 w-3 sm:h-4 sm:w-5'/>Request Changes</div>
                        <div className='bg-red-800 text-red-500 flex justify-center items-center sm:gap-2 rounded-md sm:rounded-full px-2 py-1 text-sm'><GiCancel className='h-3 w-3 sm:h-4 sm:w-5'/>Reject</div>
                    </div>
                </div>
